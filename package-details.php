...
<form name="book" method="post" action="checkout.php?amount=<?php echo htmlentities($result->PackagePrice);?>">
				...
				<ul>
					...
					<button type="submit" name="submit2" class="btn-primary btn" > Book </button>
						...
						<?php } else {?>
							...
							<a href="#" data-toggle="modal" data-target="#myModal4" class="btn-primary btn" >Booking</a></li>
							<?php } ?>
					<div class="clearfix"></div>
				</ul>
			</div>
